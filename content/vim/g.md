...
>[!NOTE]
>You can also run the command on all **lines** **NOT** matching the pattern `re`
>with command `:g!/re/command`
...
- one could also use `g/one/s/const/let/g`

### 6. Copy and move
- `:g/TODO/t $` copies all lines matching pattern `TODO` at the end of file (:h :copy)
- Invert also works, `:g!/TODO/t $` will copy everything except TODOs at end of file
