...
>field.
>
> Any code that wants to work with all objects can treat them as base
...
This technique is a clever use of type punning [^1] and there are more example like this in both C and C++.
